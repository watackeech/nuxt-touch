export default {
  "_nuxt-link.47mmbWit.js": {
    "resourceType": "script",
    "module": true,
    "prefetch": true,
    "preload": true,
    "file": "nuxt-link.47mmbWit.js",
    "imports": [
