...
const unhead_G16ZFKvCYX = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/home--LsAWE9F.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/english-fwRLC3ZN.js").then((m) => m.default || m)
  },
  {
    name: "lesson",
    path: "/lesson",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-g3GtbnGO.js").then((m) => m.default || m)
  },
  {
    name: "tower",
    path: "/tower",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/tower-rg7Yfnm-.js").then((m) => m.default || m)
  }
];
...
const revive_payload_server_BkljUG7dip = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_G16ZFKvCYX,
  plugin,
  revive_payload_server_BkljUG7dip,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.9.3_rollup@2.79.1_vite@5.0.12/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.9.3_rollup@2.79.1_vite@5.0.12/node_modules/nuxt/dist/app/components/nuxt-root.vue");
